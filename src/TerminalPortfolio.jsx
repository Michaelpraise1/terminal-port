    ...
    action: () => (
      <div className="output-section">
        ...
        <div className="flex flex-col gap-2 text-gray-300">
          <p>Whatsapp:   <a href="https://wa.me/2349018922313" target='_blank' className="text-blue-400 hover:underline">+234-9018922313</a></p>
          <p>Telegram:   <a href="https://t.me/michaeldami" target='_blank' className="text-blue-400 hover:underline">michaeldami</a></p>
